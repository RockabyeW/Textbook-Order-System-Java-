...
public class 管理员个人信息查询 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(administratorTable);
    ...
    private void fillTable(Administrator administrator) {
		...
		dtm.setRowCount(0);
		Connection con = null;
                String currentadministratorId = 登录界面.currentAdministrator.getMId();
		try {
			con = database.getCon();
			ResultSet rs = co.QuerycurrentAdministrator(con, currentadministratorId);
			while (rs.next()) {
				Vector v = new Vector();
				v.add(rs.getString("m_id"));
                                v.add(rs.getString("m_name"));
				v.add(rs.getString("m_sex"));
                                v.add(rs.getString("m_tele"));
				dtm.addRow(v);
			}
		}catch (Exception e) {
			e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(管理员个人信息查询.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
