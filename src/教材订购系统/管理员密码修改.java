...
public class 管理员密码修改 extends javax.swing.JFrame {
    ...
    private void jb_modifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jb_modifyActionPerformed
        // TODO add your handling code here:
            ...
            Connection con = null;
            con=database.getCon();
            String currentSno=登录界面.currentAdministrator.getMId();
            Administrator Administrator = new Administrator();
            Administrator.setMId(currentSno);
            
            String rightOldPassword="";
            try {
                
                
                rightOldPassword = co.Query1Passwd(con, Administrator);
            } catch (SQLException ex) {
                Logger.getLogger(管理员密码修改.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            Administrator.setMPassword(newPassword);
            try {
                con = database.getCon();
                int modifyNum = co.Modify1Password(con, Administrator);
                if (modifyNum == 1) {
