...
public class 管理员查询订单 extends javax.swing.JFrame {
    ...
    private void fillTable(Orderlist orderlist) {
		...
		try {
			con = database.getCon();
			ResultSet rs = co.QueryOrder(con);
			while (rs.next()) {
				Vector v = new Vector();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(管理员查询订单.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
