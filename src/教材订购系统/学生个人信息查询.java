...
public class 学生个人信息查询 extends javax.swing.JFrame {
    ...
    private void fillTable(Student student) {
		...
		try {
			con = database.getCon();
			ResultSet rs = co.QuerycurrentStudent(con, currentstudentId);
			while (rs.next()) {
				Vector v = new Vector();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(学生个人信息查询.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
